...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(kaolin-light
                         kaolin-aurora
                         gruvbox-light-soft)
